...
import edu.bbte.idde.krim2244.config.ConnectionPoolManager;
...
public class CarDaoJdbcImpl implements CarDao {
    ...
    @Autowired
    private ConnectionPoolManager poolConfig;
    ...
    private Car getCar(ResultSet resultSet) throws SQLException {
        ...
        */
        ...
        Car car = new Car(
                ...
                resultSet.getInt("cubicCapacity"),
                resultSet.getInt("carPower"),
    ...
    public List<Car> findByBrand(String brand) {
        ...
        try (Connection conn = poolConfig.dataSource().getConnection();
